package com.example.probarreciklerview;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void prepareMovieData() {
        MovieModel movie = new MovieModel("https://postimg.cc/34pYFndx", "Action & Adventure", "2015");
        movieList.add(movie);
        movie = new MovieModel("https://postimg.cc/34pYFndx", "Animation, Kids & Family", "2015");
        movieList.add(movie);
        movie = new MovieModel("https://postimg.cc/34pYFndx", "Action", "2015");
        movieList.add(movie);
